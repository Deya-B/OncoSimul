...
(ev <- evalAllGenotypes(my_DAG, order = FALSE, addwt = TRUE)) #The Fitness of all posible genotypes
```
...
(not_mono_pop[[1]]$pops.by.time) #Population size of each gebotype by time.
