...
For STUN it is a easy as making a vector with all the GenotypeLabels of all the simulations and making a table with it. For SeqFix, the table will tell us how many times the double-mutant is obtained, but we should also check if no STUN has happend by making sure that one single-mutant is fixated.
